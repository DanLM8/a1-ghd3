...
WARNING: For some reason this link does not work when clicked directly here. However, when I put it in my browser, it works. 
...
Technical and Design Achievements: 
    ...
    - Created a color gradient to put the character in short sleeves
    - Added a path for the character's smile
    - Learned how to place text within an SVG to add instructions
